...
function prepareCanvas(canvasDiv, canvasWidth, canvasHeight)
{
	...
	context.fillText("loading...", 140, 140);
...
function redraw() {
  ...
  context.drawImage(images["torso"], x - 30, y - 205);
  context.drawImage(images["head"], x - 30, y - 200 - breathAmt);
  context.drawImage(images["legs"], x - 30, y - 210);
  
  if (jumping) {
	context.drawImage(images["rightArm-jump"], x - 35, y - 200 - breathAmt);
  } else {
	context.drawImage(images["rightArm"], x - 30, y - 200 - breathAmt);
  }
